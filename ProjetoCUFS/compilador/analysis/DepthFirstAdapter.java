...
import compilador.node.ABoolValor;
import compilador.node.ACasosAvalie;
import compilador.node.ACausaSeCausaSe;
import compilador.node.ACharValor;
import compilador.node.AComandoAvalieComando;
import compilador.node.AComandoCaseComandoCaso;
import compilador.node.AComandoCondicionalComandos;
import compilador.node.AComandoEnquantoComando;
import compilador.node.AComandoEscrevaComando;
import compilador.node.AComandoLeiaComando;
import compilador.node.AComandoPara1Comando;
import compilador.node.AComandoParaComandoPara;
import compilador.node.AComandoPassoComando;
import compilador.node.AComandoRepitaComando;
import compilador.node.AComandoSeComando;
import compilador.node.AComandoSenaoAvalieComandoSenao;
import compilador.node.AComandoSenaoSeComandoSenao;
import compilador.node.ACondicaoAvalie;
import compilador.node.ACondicaoSeCondicaoSe;
import compilador.node.AConstanteDeclaracao;
import compilador.node.ADiferenteFatorLogico;
import compilador.node.ADivExpressao;
import compilador.node.AEExpLogica;
import compilador.node.AExpAninhadaExpLogica;
import compilador.node.AExpLogicaExp;
import compilador.node.AExpOuExplogica;
import compilador.node.AExpressaoExp;
import compilador.node.AFatorLogicoTermoLogico;
import compilador.node.AFinalTermo;
import compilador.node.AFloatValor;
import compilador.node.AIgualFatorLogico;
import compilador.node.AInicioProg;
import compilador.node.AIntValor;
import compilador.node.AMaiorFatorLogico;
import compilador.node.AMaiorqFatorLogico;
import compilador.node.AMenorFatorLogico;
import compilador.node.AMenorqFatorLogico;
import compilador.node.AMultExpressao;
import compilador.node.ANaoExpLogica;
import compilador.node.AOuExpLogica;
import compilador.node.ASomaExpressao;
import compilador.node.AStrValor;
import compilador.node.ASubExpressao;
import compilador.node.ATboolTipo;
import compilador.node.ATermoExpressao;
import compilador.node.ATermoLogicoExpLogica;
import compilador.node.ATfloatTipo;
import compilador.node.ATintTipo;
import compilador.node.ATstrTipo;
import compilador.node.AUmIdentificadorPosicao;
import compilador.node.AUmInteiroPosicao;
import compilador.node.AUmaExpressaoExpEscreva;
import compilador.node.AUmaVariavelExpressaoFinal;
import compilador.node.AUmaVariavelVar;
import compilador.node.AValorAninahdoExpressaoFinal;
import compilador.node.AValorFinalExpressaoFinal;
import compilador.node.AVariasExpressoesExpEscreva;
import compilador.node.AVariasVariaveisVar;
import compilador.node.AVariaveisDeclaracao;
import compilador.node.AVariavelNegativaExpressaoFinal;
import compilador.node.AVariavelVarOuVetor;
import compilador.node.AVariosCasesCondComandoCasos;
import compilador.node.AVariosComandosCondComando;
import compilador.node.AVariosComandosParaCondComandoPara;
import compilador.node.AVetorVarOuVetor;
import compilador.node.AXorExpLogica;
import compilador.node.Node;
import compilador.node.PComando;
import compilador.node.PComandoCaso;
import compilador.node.PComandoPara;
import compilador.node.PDeclaracao;
