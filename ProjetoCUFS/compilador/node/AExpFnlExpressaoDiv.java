...
public final class AExpFnlExpressaoDiv extends PExpressaoDiv
{
    private PIndiceExp _indiceExp_;

    public AExpFnlExpressaoDiv()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpFnlExpressaoDiv(
    ...
    {
        ((Analysis) sw).caseAExpFnlExpressaoDiv(this);
    }
