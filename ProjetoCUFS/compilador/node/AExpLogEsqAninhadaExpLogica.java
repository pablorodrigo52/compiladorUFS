...
public final class AExpLogEsqAninhadaExpLogica extends PExpLogica
{
    private TAparentese _aparentese_;
    private PExpLogica _expLogica_;
    private TFparentese _fparentese_;

    public AExpLogEsqAninhadaExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogEsqAninhadaExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpLogEsqAninhadaExpLogica(this);
    }
