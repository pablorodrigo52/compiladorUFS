...
public final class AFatorAninhadoExpressaoFator extends PExpressaoFator
{
    private TAparentese _aparentese_;
    private PExpressaoFator _expressaoFator_;
    private TFparentese _fparentese_;

    public AFatorAninhadoExpressaoFator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFatorAninhadoExpressaoFator(
    ...
    {
        ((Analysis) sw).caseAFatorAninhadoExpressaoFator(this);
    }
