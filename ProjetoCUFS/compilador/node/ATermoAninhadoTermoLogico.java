...
public final class ATermoAninhadoTermoLogico extends PTermoLogico
{
    private TAparentese _aparentese_;
    private PExpLogica _expLogica_;
    private TFparentese _fparentese_;

    public ATermoAninhadoTermoLogico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATermoAninhadoTermoLogico(
    ...
    {
        ((Analysis) sw).caseATermoAninhadoTermoLogico(this);
    }
