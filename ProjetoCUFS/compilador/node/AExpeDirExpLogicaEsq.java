...
public final class AExpeDirExpLogicaEsq extends PExpLogicaEsq
{
    private PExpLogicaDir _expLogicaDir_;

    public AExpeDirExpLogicaEsq()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpeDirExpLogicaEsq(
    ...
    {
        ((Analysis) sw).caseAExpeDirExpLogicaEsq(this);
    }
