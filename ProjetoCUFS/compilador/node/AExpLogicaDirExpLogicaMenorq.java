...
public final class AExpLogicaDirExpLogicaMenorq extends PExpLogicaMenorq
{
    private PExpLogicaDir _expLogicaDir_;

    public AExpLogicaDirExpLogicaMenorq()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogicaDirExpLogicaMenorq(
    ...
    {
        ((Analysis) sw).caseAExpLogicaDirExpLogicaMenorq(this);
    }
