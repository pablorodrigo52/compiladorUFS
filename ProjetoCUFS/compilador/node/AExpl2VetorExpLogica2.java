...
public final class AExpl2VetorExpLogica2 extends PExpLogica2
{
    private PVarvetor _varvetor_;

    public AExpl2VetorExpLogica2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpl2VetorExpLogica2(
    ...
    {
        ((Analysis) sw).caseAExpl2VetorExpLogica2(this);
    }
