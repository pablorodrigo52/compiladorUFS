...
public final class ATermoMultiplicacaoTermo extends PTermo
{
    private PTermo _termo_;
    private TMult _mult_;
    private PFator _fator_;

    public ATermoMultiplicacaoTermo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATermoMultiplicacaoTermo(
    ...
    {
        ((Analysis) sw).caseATermoMultiplicacaoTermo(this);
    }
