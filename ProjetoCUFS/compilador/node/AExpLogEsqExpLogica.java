...
public final class AExpLogEsqExpLogica extends PExpLogica
{
    private PExpLogicaEsq _expLogicaEsq_;

    public AExpLogEsqExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogEsqExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpLogEsqExpLogica(this);
    }
