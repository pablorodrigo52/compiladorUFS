...
public final class AExpressaoEsqExpressao extends PExpressao
{
    private PExpressaoEsq _expressaoEsq_;

    public AExpressaoEsqExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressaoEsqExpressao(
    ...
    {
        ((Analysis) sw).caseAExpressaoEsqExpressao(this);
    }
