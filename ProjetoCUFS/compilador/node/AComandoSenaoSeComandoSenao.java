...
public final class AComandoSenaoSeComandoSenao extends PComandoSenao
{
    private TSenao _senao_;
    private PComandos _comandos_;
    private PComando _comando_;

    public AComandoSenaoSeComandoSenao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoSenaoSeComandoSenao(
    ...
    {
        ((Analysis) sw).caseAComandoSenaoSeComandoSenao(this);
    }
