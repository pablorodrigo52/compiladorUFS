...
public final class AExpdVetorExpLogicaDir extends PExpLogicaDir
{
    private PVarvetor _varvetor_;

    public AExpdVetorExpLogicaDir()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpdVetorExpLogicaDir(
    ...
    {
        ((Analysis) sw).caseAExpdVetorExpLogicaDir(this);
    }
