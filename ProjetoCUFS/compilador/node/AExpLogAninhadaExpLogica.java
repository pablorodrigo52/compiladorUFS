...
public final class AExpLogAninhadaExpLogica extends PExpLogica
{
    private TAparentese _aparentese_;
    private PExpLogica _expLogica_;
    private TFparentese _fparentese_;

    public AExpLogAninhadaExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogAninhadaExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpLogAninhadaExpLogica(this);
    }
