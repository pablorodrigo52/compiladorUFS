...
public final class AFatorVetorFatorExp extends PFatorExp
{
    private PVarvetor _varvetor_;

    public AFatorVetorFatorExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFatorVetorFatorExp(
    ...
    {
        ((Analysis) sw).caseAFatorVetorFatorExp(this);
    }
