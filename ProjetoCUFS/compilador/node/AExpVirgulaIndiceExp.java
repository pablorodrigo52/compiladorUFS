...
public final class AExpVirgulaIndiceExp extends PIndiceExp
{
    private PExpressao _expressao_;
    private TVirgula _virgula_;

    public AExpVirgulaIndiceExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpVirgulaIndiceExp(
    ...
    {
        ((Analysis) sw).caseAExpVirgulaIndiceExp(this);
    }
